...
private:
    ...
    void inorderBranchTraversal(Node* leaf) const {
        if (leaf != nullptr) {
            inorderBranchTraversal(leaf -> left);
            if (((leaf -> left == nullptr) && (leaf-> right != nullptr)) || ((leaf -> left != nullptr) && (leaf-> right == nullptr))) {
                cout << leaf -> value << '\n';
            }
            inorderBranchTraversal(leaf -> right);
        }
    }
...
public:
    ...
    void inorderBranchTraversal() const {
        return inorderBranchTraversal(root);
    }
