...
private:
    ...
    void inorderForkTraversal(Node* leaf) const {
        if (leaf != nullptr) {
            inorderForkTraversal(leaf -> left);
            if ((leaf -> left != nullptr) && (leaf-> right != nullptr)) {
                cout << leaf -> value << '\n';
            }
            inorderForkTraversal(leaf -> right);
        }
    }
...
public:
    ...
    void inorderForkTraversal() const {
        return inorderForkTraversal(root);
    } 
