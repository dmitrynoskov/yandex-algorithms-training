...
private:
    ...
    void inorderLeafTraversal(Node* leaf) const {
        if (leaf != nullptr) {
            inorderLeafTraversal(leaf -> left);
            if ((leaf -> left == nullptr) && (leaf-> right == nullptr)) {
                cout << leaf -> value << '\n';
            }
            inorderLeafTraversal(leaf -> right);
        }
    }
...
public:
    ...
    void inorderLeafTraversal() const {
        return inorderLeafTraversal(root);
    } 
